...
public class XorTest extends CircuitGenerator {
    ...
    public XorTest() {
      ...
      this.evaluateSampleRun(new SampleRun("Sample_Run1", true) {
        public void pre() {
          ...
          a.mapValue(new BigInteger("11", 16), CircuitGenerator.__getActiveCircuitGenerator().__getCircuitEvaluator());
          c.mapValue(new BigInteger("ba", 16), CircuitGenerator.__getActiveCircuitGenerator().__getCircuitEvaluator());
          d.mapValue(new BigInteger("93", 16), CircuitGenerator.__getActiveCircuitGenerator().__getCircuitEvaluator());
        }
        public void post() {
        }
    ...
    public void outsource() {
      ...
      a.mul(UnsignedInteger.instantiateFrom(8, x)).forceEqual(d);
    }
